                ...
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        <v-form ref="form">
                            ...
                            <v-text-field v-if="!isEdit" name="password" label="Password" type="password" autocomplete="new-password" 
                            ...
                            <v-text-field v-if="!isEdit" name="passwordRepeat" label="Repeat password" type="password" autocomplete="new-password" 
